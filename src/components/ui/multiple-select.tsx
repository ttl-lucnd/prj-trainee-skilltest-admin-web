...
interface MultiSelectProps
  ...
  /**
   * An array of specific option objects to be displayed in the multi-select component.
   * Each option object has a label, value, and an optional icon.
   */
  specificOptions?: {
    /** The text to display for the option. */
  ...
  /**
   * The value of the multi-select component.
   * Optional, can be used to set the value of the multi-select component.
   */
  value?: string[];
}
          ...
          >
            {selectedValues.length > 0 ? (
              <div className="flex justify-between items-center w-full">
                <div className="flex gap-0.5 items-center max-w-[calc(100%-50px)]">
                  {selectedValues.slice(0, maxCount).map((value) => {
                    ...
                    return (
                      <Badge
                        key={value}
                        className={cn(
                          'w-full px-1.5 max-w-[100px] min-w-[20px]',
                ...
                {specificOptions?.map((option, index) => {
                  ...
                  return (
                    <React.Fragment key={option.value}>
                      ...
                      {index === specificOptions.length - 1 && (
