...
export function SubjectList() {
  ...
  const { updateUrlWithQuery: updateSubjectPageUrlWithQuery } = useUpdateUrlWithQuery();

  const setSubjectPageGetListQuery = (query: ICommonListQuery) => {
    setSubjectGetListQuery(query);
    updateSubjectPageUrlWithQuery(query);
  };
  ...
  return (
    <div className="h-full flex flex-col gap-2.5">
      ...
      <Pagination
        ...
        onPageChange={(page) => setSubjectPageGetListQuery({ page })}
      >
