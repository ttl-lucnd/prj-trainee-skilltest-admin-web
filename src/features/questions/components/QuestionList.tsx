    ...
    <div className="h-full flex flex-col gap-2.5">
      ...
      >
        <div className="flex items-center gap-2.5 justify-end">
          <Button size="sm" variant={'outline'} onClick={() => setOpenSettingFormDialog(true)}>{t('common.buttons.setting_url')}</Button>
          <Button size="sm" onClick={() => setOpenSyncDataDialog(true)}>{t('common.buttons.setting_url')}</Button>
        </div>
      </Pagination>
    </div>
  );
